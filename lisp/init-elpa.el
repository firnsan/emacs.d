...
;;zhao(require-package 'haskell-mode '(13 7 0) nil)
...
;;zhao(require-package 'erlang '(20120612 0 0) nil)
...
;;zhao(require-package 'textile-mode)
...
;;zhao(require-package 'csharp-mode)
(require-package 'emmet-mode)
(require-package 'session)
;; (require-package 'tidy)
(require-package 'unfill)
;;zhao(require-package 'w3m)
(require-package 'idomenu)
(if *emacs24* (require-package 'ggtags))
(require-package 'buffer-move)
(require-package 'switch-window)
(require-package 'cpputils-cmake '(0 4 22) nil)
;;zhao 好多buffer显示flyspelll插件错误 (require-package 'flyspell-lazy)
